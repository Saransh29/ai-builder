      ...
      <div className=" w-full justify-center text-center inline-flex -space-x-px">
        <div className="flex flex-col items-center">
          <span className="text-sm text-gray-700 ">
            <span className="font-semibold px-1 text-gray-900 ">
            ...
            of
            <span className="font-semibold px-1 text-gray-900 "> {total}</span>
            Entries
          </span>
          <div className="inline-flex mt-2 xs:mt-0">
            <button
              onClick={gotoPrevious}
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-gray-500 rounded-l hover:bg-gray-900"
            >
              <svg
                aria-hidden="true"
